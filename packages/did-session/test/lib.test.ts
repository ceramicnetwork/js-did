...
test('gitcoin broken CACAO', async () => {
  const cacao = {
    h: {
      t: 'eip4361',
    },
  ...
  const jws = {
    ...
    signatures: [
      {
        protected:
          '',
        signature:
          'F4V-EpyUujZGIrgx0bify8AWMgAVviNFMB5vHW7oxEk0OyFsl4UKmmzLKb2bN0GnUJi0rrkUy8FmRFqgPgEWQQ',
      },
    ],
  }
  const did = new DID({
  ...
  const verified = await did.verifyJWS(jws, {
    issuer: 'did:pkh:eip155:1:0xeeec6dcedfe42e5ff150d0165c816106c4633ac2',
    capability: cacao,
  })
