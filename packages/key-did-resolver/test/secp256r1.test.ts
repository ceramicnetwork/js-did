...
test('a uncompressed public key in hex to an x,y point with x, and y url encoded with an unsupported prefix', () => {
...
test('a hex string longer than 65 bytes', () => {
  const inputPublicKeyHex =
...
test('a hex string longer than 65 bytes: try2', () => {
  const inputPublicKeyHex =
...
test('a compressed public key in hex to an x,y point as BigInt (with the wrong parity)', () => {
