...
test('a hex string longer than 67 bytes', () => {
  const inputPublicKeyHex =
...
test('a hex string longer than 67 bytes: try2', () => {
  const inputPublicKeyHex =
...
test('key decompression (y-coordinate even)', () => {
  const inputCompressedPoint = Uint8Array.from([
    2, 1, 136, 150, 76, 97, 65, 179, 107, 240, 223, 46, 252, 94, 95, 182, 167, 112, 107, 112, 89,
    123, 182, 47, 127, 128, 174, 58, 9, 124, 57, 243, 252, 135, 25, 91, 0, 99, 153, 233, 154, 136,
    48, 21, 214, 42, 104, 181, 152, 232, 34, 58, 26, 117, 10, 127, 126, 153, 27, 98, 170, 127, 154,
    76, 15, 186, 131,
  ])
  const output = {
...
test('key decompression (y-coordinate odd)', () => {
  const inputCompressedPoint = Uint8Array.from([
    3, 0, 151, 143, 203, 135, 104, 78, 187, 251, 114, 62, 105, 95, 166, 228, 102, 64, 224, 86, 36,
    243, 227, 190, 158, 1, 194, 63, 113, 48, 136, 170, 84, 42, 128, 6, 194, 89, 182, 168, 21, 47,
    89, 145, 191, 55, 19, 234, 218, 6, 185, 235, 48, 192, 252, 197, 201, 248, 119, 20, 62, 81, 208,
    201, 96, 248, 228,
  ])
  const output = {
